function varargout = snake3(varargin)
% SNAKE3 MATLAB code for snake3.fig
%      SNAKE3, by itself, creates a new SNAKE3 or raises the existing
%      singleton*.
%
%      H = SNAKE3 returns the handle to a new SNAKE3 or the handle to
%      the existing singleton*.
%
%      SNAKE3('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SNAKE3.M with the given input arguments.
%
%      SNAKE3('Property','Value',...) creates a new SNAKE3 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before snake3_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to snake3_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help snake3

% Last Modified by GUIDE v2.5 25-Nov-2022 14:10:53

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @snake3_OpeningFcn, ...
                   'gui_OutputFcn',  @snake3_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before snake3 is made visible.
function snake3_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to snake3 (see VARARGIN)

% Choose default command line output for snake3
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes snake3 wait for user response (see UIRESUME)
% uiwait(handles.figure1);
axes(handles.axes1);
axis('off');

% --- Outputs from this function are returned to the command line.
function varargout = snake3_OutputFcn(hObject, eventdata, handles) 
